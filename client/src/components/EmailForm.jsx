        ...
        <div className="space-y-6 w-full max-w-2xl mx-auto transition-colors">
            ...
            {templates.length > 0 && (
                <div className="relative mb-8">
                    ...
                    {showTemplates && (
                        <div className="absolute top-full left-0 right-0 mt-2 bg-[var(--bg-card)] border border-[var(--border-muted)] rounded-2xl shadow-xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <div className="relative">
                <label className="block text-sm font-black text-[var(--text-muted)] uppercase tracking-widest mb-2 transition-colors">
                    Email Body
