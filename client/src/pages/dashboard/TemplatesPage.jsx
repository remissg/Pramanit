                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div>
                        ...
                        >
                            ...
                            <span className="truncate">SMTP Dispatch Blueprints</span>
                        </div>
                        ...
                        <p className="text-xs sm:text-sm font-semibold text-[var(--text-muted)] mt-2 max-w-xl leading-relaxed">
                            Configure SMTP email notification blueprints sent automatically to recipients upon credential issuance.
                        </p>
                    </div>
                    <button
